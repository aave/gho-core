...
import { MockGhoFlashBorrower__factory, GhoFlashMinter__factory } from '../../types';
import { ZERO_ADDRESS } from '../helpers/constants';
import { aaveMarketAddresses, ghoEntityConfig } from '../helpers/config';

import './helpers/math/wadraymath';

makeSuite('Gho FlashMinter - Optimized', (testEnv: TestEnv) => {
  let ethers;
  let flashBorrower;
  let flashFee;
  let tx;
  ...
  before(async () => {
    ...
    const flashBorrowerFactory = new MockGhoFlashBorrower__factory(deployer.signer);
